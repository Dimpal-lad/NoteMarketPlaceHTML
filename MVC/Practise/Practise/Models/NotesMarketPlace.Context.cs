...
namespace Practise.Models
{
    ...
    public partial class NotesMarketPlaceEntities2 : DbContext
    {
        public NotesMarketPlaceEntities2()
            : base("name=NotesMarketPlaceEntities2")
        {
        }
        ...
        public virtual DbSet<tblSellerNotesAttachment> tblSellerNotesAttachments { get; set; }
